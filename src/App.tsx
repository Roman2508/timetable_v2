...
// 12. При зміні типу розкладу (group | teacher | auditory) треба очищати overlay
// 13. При зміні групи в розкладі треба очищати список всіх виставлених уроків
// 14. Треба дозволити об'єднувати в потік групи в яких різні назви дисциплін, (при цьому години і семестр повинні бути однаковими???) години і семестр можуть відрізнятись
// 15. Якщо в викладача вже був виставлений розклад і після цього прикріплюється google calendar id треба знайти
//     всі виставлені уроки і додати їх до календаря
// 16. Треба зробити можливість ставити в розклад (поза планом, тобто не йде в навантаження) практики або інші види діяльності ????
// 17. Перевірити як працює зміна року навчання
// 18. Накладки аудиторій при виставленні підгруп (можна поставити 2 пари в 1 аудиторію) - fix it
// 19. Авторизація в Google Calendar Error: listen EADDRINUSE: address already in use :::4000
// 20. треба забрати alert("Дисципліна не вибрана") при кліку на вже виставлений ел.розкладу
