...
// ================== Розклад ==================
// =============================================
// 1. // FIX // При зміні selectedItemId <Calendar /> 2 рази підвантажується
...
// 19. При першому відкритті розкладу (після npm run dev) завантажується розклад декілька разів (для різних груп)
