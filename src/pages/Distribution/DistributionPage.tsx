...
const DistributionPage = () => {
  const [attachmentType, setAttachmentType] = React.useState<string | null>("left")

  const handleAttachment = (_: React.MouseEvent<HTMLElement>, newAttachment: string | null) => {
          ...
          <Grid item xs={4} sx={{ mx: 2 }}>
            <Grid item xs={12} sx={{ mb: 2 }}>
              <MainCard>
                ...
                >
                  <Tooltip title="Відкріпити всі">
                    <ToggleButton value="left" aria-label="left aligned">
                      <ClearOutlined />
                    </ToggleButton>
                  </Tooltip>

                  <Tooltip title="Відкріпити від одного">
                    <ToggleButton value="center" aria-label="centered">
                      <CloseCircleOutlined />
                    </ToggleButton>
                  </Tooltip>

                  <Tooltip title="Прикріпити на всі">
                    <ToggleButton value="right" aria-label="right aligned">
                      <BackwardOutlined />
                    </ToggleButton>
                  </Tooltip>

                  <Tooltip title="Прикріпити одного">
