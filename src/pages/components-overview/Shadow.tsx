...
const ShadowBox: React.FC<IshadowProps> = ({ shadow }) => {
  return (
...
interface ICustomShadowBoxProps {
  shadow: string
  color: string
  label: string
  bgcolor?: string
...
const CustomShadowBox: React.FC<ICustomShadowBoxProps> = ({ shadow, label, color, bgcolor }) => {
  return (
