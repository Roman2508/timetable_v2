...
export const planSubjectsAPI = {
  ...
  updateSubjectName(payload: UpdateSubjectNamePayloadType) {
    return instanse.patch<{ id: number; name: string; cmk: number }[]>(
      "/plan-subjects/name",
      payload
    )
  },
...
export const groupLoadLessonsAPI = {
  ...
  attachSpecialization(payload: AttachSpecializationPayloadType) {
    return instanse.patch<AttachSpecializationPayloadType>(
      `/group-load-lessons/specialization`,
      payload
    )
  },
...
export const scheduleLessonsAPI = {
  ...
  update(payload: UpdateScheduleLessonsPayloadType) {
    const { id, auditory } = payload
    return instanse.patch<ScheduleLessonType>(`/schedule-lessons/${id}`, { auditory })
  },
  delete(id: number) {
